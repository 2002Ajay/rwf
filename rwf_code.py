...
from keras.layers import Input, Dense, Flatten, Conv3D, MaxPooling3D, Dropout, BatchNormalization, Activation, LeakyReLU, Add, Multiply
...
dataset = "C:/Users/ajayt/OneDrive/Desktop/Main P/other/our_method/RWF2000_Main Codes/npy_data"

train_generator = DataGenerator(directory=f'{dataset}/train', 
                                batch_size=batch_size, 
                                data_augmentation=False)

val_generator = DataGenerator(directory=f'{dataset}/val',
                              batch_size=batch_size, 
                              data_augmentation=False)
